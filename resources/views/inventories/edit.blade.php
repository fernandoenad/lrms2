...
<div class="row mb-4">
    <div class="col-sm-6">
        <h1 class="m-0 text-dark">Modify LR Item</h1>
    </div>
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></li>
            <li class="breadcrumb-item"><a href="{{ route('inventory') }}">LR Inventory</a></li>
            <li class="breadcrumb-item active">Modify LR Item</li>
        </ol>
    </div>
</div>
        ...
        <div class="card card-outline card-primary">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <input id="title" type="text" class="form-control @error('title') is-invalid @enderror" name="title" value="{{ old('title') ?? $inventory->title ?? '' }}" placeholder="e.g. Ibong Adarna" autocomplete="title" autofocus>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <input list="learningareas" id="learningarea" type="text" class="form-control @error('learningarea') is-invalid @enderror" name="learningarea" placeholder="e.g. English, Filipino, Mathematics" value="{{ old('learningarea') ?? $inventory->learningarea ?? '' }}" autocomplete="learningarea" autofocus>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <input id="author" type="text" class="form-control @error('author') is-invalid @enderror" name="author" value="{{ old('author') ?? $inventory->author ?? ''}}" placeholder="N/A of none." autocomplete="author" autofocus>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <input id="publisher" type="text" class="form-control @error('publisher') is-invalid @enderror" name="publisher" value="{{ old('publisher') ?? $inventory->publisher ?? '' }}" placeholder="N/A of none." autocomplete="publisher" autofocus>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <input list="lrtypes" id="lrtype" type="text" class="form-control @error('lrtype') is-invalid @enderror" name="lrtype" value="{{ old('lrtype') ?? $inventory->lrtype ?? ''}}" placeholder="e.g. Module, Worksheet, Book, Activity Sheet, etc." autocomplete="lrtype" autofocus>
                        <datalist id="lrtypes">
                            <?php 
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <input id="acquisitiondate" type="date" class="form-control @error('acquisitiondate') is-invalid @enderror" name="acquisitiondate" value="{{ old('acquisitiondate') ?? $inventory->acquisitiondate ?? '' }}" autocomplete="acquisitiondate" autofocus>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <select id="acquisitionmode" type="text" class="form-control @error('acquisitionmode') is-invalid @enderror" name="acquisitionmode" value="{{ old('acquisitionmode') }}" autocomplete="acquisitionmode" autofocus>
                            <option value="">Select</option>
                            <option value="Donated" @if(old('acquisitionmode') == 'Donated' || $inventory->acquisitionmode == 'Donated') {{ 'selected' }} @endif>Donated</option>
                            <option value="Procured" @if(old('acquisitionmode') == 'Procured' || $inventory->acquisitionmode == 'Procured') {{ 'selected' }} @endif>Procured</option>
                        </select>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <input id="copies" type="number" class="form-control @error('copies') is-invalid @enderror" name="copies" value="{{ old('copies') ?? $inventory->copies ?? '' }}" placeholder="0" autocomplete="copies" autofocus>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <select id="status" type="text" class="form-control @error('status') is-invalid @enderror" name="status" value="{{ old('status') }}" autocomplete="status" autofocus>
                            <option value="">Select</option>
                            <option value="Distributed to Learners" @if(old('status') == "Distributed to Learners" || $inventory->status == "Distributed to Learners") {{ 'selected' }} @endif>Distributed to Learners</option>
                            <option value="Not Distributed to Learners" @if(old('status') == "Not Distributed to Learners" || $inventory->status == "Not Distributed to Learners") {{ 'selected' }} @endif>Not Distributed to Learners</option>
                        </select>
                        @error('status')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
